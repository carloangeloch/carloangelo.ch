...
const Header = () => {
    ...
    if (appContext.appData.currentPage != 'v2-work' || appContext.appData.currentPage != 'v2-home' || appContext.appData.currentPage != 'v2-profile' || appContext.appData.currentPage != 'v2-contact') {
        return (
